...
import 'package:loginpagecheck/debit_form.dart';

void Debitapp() async {
  WidgetsFlutterBinding.ensureInitialized();
  await Firebase.initializeApp();
  runApp(const Debitpage());
}
...
// text fields' controllers
  ...
  final CollectionReference _user1 =
      FirebaseFirestore.instance.collection('userdata').doc(FirebaseAuth.instance.currentUser?.uid).collection('debit');
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(Color.fromARGB(143, 0, 0, 255))),
                  onPressed: () async {
                    final String name = _nameController.text;
                    final double? Amount =
                        double.tryParse(_AmountController.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Owed to me')),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              new MaterialPageRoute(builder: ((context) => new form1())));
        },
        backgroundColor: Color.fromARGB(143, 0, 0, 255),
        tooltip: 'Increment',
